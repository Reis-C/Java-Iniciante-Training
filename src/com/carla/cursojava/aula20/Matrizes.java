package com.carla.cursojava.aula20;


public class Matrizes {
//armazenar as 4 notas anuais de 30 alunos
    public static void main(String[] args) {
        ...
        notasAlunos[1][3] = 8;//mudanca de nota
        ...
        double[][] notasAlunos2 = {{7, 8, 9, 10}, {8, 6, 7, 10}}; //matriz
